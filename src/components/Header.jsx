...
const Header = () => {
    return <div className="header container">
        <div className="row">
            <h2>Md. Om<span>a</span>r</h2>
            <h2>F<span>ar</span>uk</h2>
        </div>
        <hr />
        <div className="row">
            <span>MERN Stack Developer</span>
            <a href="https://www.google.com" target="_blank" >Resume</a>
            <a href="mailto:omarpherones@gmail.com" target="_blank" >Email</a>
        ...
        <hr />
        <div className="row">
            <h2>MERN St<span>a</span>ck Dev<span>el</span>oper</h2>
        </div>
        <hr />
        <div className="row">
            <h2>Based</h2>
